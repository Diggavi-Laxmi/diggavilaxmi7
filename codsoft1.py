data = {
    ...
    "do you have any hobbies or interests": "I'm always busy helping users, so my hobby is chatting with people like you! I can help you find delicious recipes and food-related information.",
...
print("Chatbot: Hi! I'm a simple chatbox, I'm here to assist you")
while True:
    user_input=input("Me:")
    if user_input=='bye':
